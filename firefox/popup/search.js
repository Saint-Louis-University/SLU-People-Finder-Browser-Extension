...
//	setTimeout(() => { document.querySelector('#search_text').focus(); console.log("dom 100"); }, 500);
//});

//window.addEventListener("load", function(event) {
//	setTimeout(() => { document.querySelector('#search_text').focus(); console.log("load 150"); }, 500);
//});
